...
function seedData() {
  ...
  const lottoResults = [
    [1222, '2026-05-02', 4, 11, 17, 22, 32, 41, 34, 1202986844, 24],
    [1221, '2026-04-25', 6, 13, 18, 28, 30, 36, 9, 1830801165, 16],
    [1220, '2026-04-18', 2, 22, 25, 28, 34, 43, 16, 2114514161, 14],
    [1219, '2026-04-11', 1, 2, 15, 28, 39, 45, 31, 2508232844, 12],
    [1218, '2026-04-04', 3, 28, 31, 32, 42, 45, 25, 1714482042, 18],
    [1217, '2026-03-28', 8, 10, 15, 20, 29, 31, 41, 2179738018, 14],
  ...
  // 영상 콘텐츠 (책 쇼츠, 조합기/앱 소개, 라이브 다시보기)
  const videoSeed = [
    ['book', '저자 정연식 - 26년의 연구', 'YOUTUBE_ID_1', '로또 1등 패턴의 정석 저자 인터뷰', 1],
    ['book', '책 1화 - 패턴 분석의 기초', 'YOUTUBE_ID_2', '책 내용 쇼츠 1편', 0],
    ['book', '책 2화 - 158개 패턴의 의미', 'YOUTUBE_ID_3', '책 내용 쇼츠 2편', 0],
    ['machine', 'LB-88 Pro 분석기 사용법', 'YOUTUBE_ID_4', '조합기 소개 영상', 0],
    ['app', '로또벅스88 앱 둘러보기', 'YOUTUBE_ID_5', '앱 기능 소개 영상', 0],
    ['live', '제1222회 라이브 다시보기 (2026-05-02)', 'YOUTUBE_ID_6', '이번 주 분석 라이브', 0],
    ['live', '제1221회 라이브 다시보기 (2026-04-25)', 'YOUTUBE_ID_7', '지난 주 분석 라이브', 0],
    ['live', '제1220회 라이브 다시보기 (2026-04-18)', 'YOUTUBE_ID_8', '4월 셋째주 라이브', 0],
  ];
  videoSeed.forEach(([category, title, youtube_id, description, is_pinned]) => {
    db.run(`INSERT INTO videos (category, title, youtube_id, description, is_pinned)
      VALUES (?, ?, ?, ?, ?)`, [category, title, youtube_id, description, is_pinned]);
  });
