...
router.get('/live', (req, res) => {
  const liveVideos = db.query(`SELECT * FROM videos WHERE category = 'live' ORDER BY is_pinned DESC, created_at DESC`);
  res.render('live', { title: '라이브 방송 - 로또벅스88', liveVideos });
});

// 영상 페이지 (책 쇼츠, 조합기, 앱 소개)
